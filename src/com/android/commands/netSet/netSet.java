...
public class netSet {
	...
	private void displayInfo(String msg) {
        ...
        SystemProperties.set("dhcp.eth0.mask", mEthNetmask);
        SystemProperties.set("dhcp.eth0.gateway", mEthGateway);
        SystemProperties.set("dhcp.eth0.dns1", mEthdns1);
